...
public class JdbcDaoUsingDaoSupport extends JdbcDaoSupport {
	...
	private static final String GET_COUNT_QUERY = "SELECT COUNT(*) FROM employee;";
	private static final String SELECT_QUERY = "SELECT * FROM employee;";
	private static final String UPDATE_QUERY = "UPDATE employee SET name=? WHERE id=1;";
	...
	public int getEmployeesCount() {
		int count = getJdbcTemplate().queryForObject(GET_COUNT_QUERY, Integer.class);
		return count;
	}
	...
	public void updateEmployee(int id) {
		...
		getJdbcTemplate().update(UPDATE_QUERY, id);
	}
