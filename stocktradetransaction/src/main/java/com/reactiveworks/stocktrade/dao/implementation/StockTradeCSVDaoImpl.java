...
public class StockTradeCSVDaoImpl implements IStockTradeDao {
	 ...
	 * implementation of IStockTradeDao method createStockTradeRecord().
	 * 
	 * @throws OperationNotSupportedException when updateStockTradeRecord() method
	 *                                        is called.
	 */
	@Override
	public void updateStockTradeRecord(int stockTradeId, double volume) throws OperationNotSupportedException {

		throw new OperationNotSupportedException("updateStockTradeRecord() method is not supprted");

	}

	/**
	 * implementation of IStockTradeDao method deleteStockTradeRecord().
	 * 
	 * @throws OperationNotSupportedException when deleteStockTradeRecord() method
	 *                                        is called.
	 */
	@Override
